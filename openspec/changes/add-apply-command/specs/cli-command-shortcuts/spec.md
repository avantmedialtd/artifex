...
#### Scenario: Unknown top-level command after adding apply

- **GIVEN** the apply shorthand has been added
...
- **AND** suggests running 'zap help' to see all available commands
- **AND** exits with status code 1
