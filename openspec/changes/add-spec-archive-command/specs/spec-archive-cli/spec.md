...
Provide a CLI command that allows developers to archive OpenSpec changes by invoking Claude Code's archive workflow with a simple, memorable command syntax.
