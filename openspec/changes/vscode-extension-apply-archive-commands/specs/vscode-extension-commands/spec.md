...
Provide context menu commands in the VSCode extension to execute `zap apply` and `zap archive` directly from the Changes panel, with conditional visibility based on task completion status.
