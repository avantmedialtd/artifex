...
- [x] Modify `zap propose` command to auto-commit after proposal creation
...
- [x] Add utility function for extracting proposal title from proposal.md
...
- [x] Add git commit utility function
...
- [x] Add tests for auto-commit functionality
  - Mock git commands
