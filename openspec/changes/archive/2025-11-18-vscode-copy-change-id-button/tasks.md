...
- [x] Add "Copy Change ID" context menu contribution to package.json
...
- [x] Register copyChangeId command in extension.ts
...
- [x] Update OpenSpecTaskItem to support context menu command invocation
...
- [x] Test copy change ID from context menu
...
- [x] Test context menu visibility
...
- [x] Test existing copy title functionality
...
- [x] Update vscode-extension README.md with copy change ID feature
