...
## Purpose
Provide a CLI command that allows developers to create OpenSpec change proposals by invoking Claude Code's proposal workflow with a simple, memorable command syntax.
