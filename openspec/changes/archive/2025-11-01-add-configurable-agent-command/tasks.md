...
- [x] **Update `utils/claude.ts` to read ZAP_AGENT environment variable**
...
- [x] **Update `commands/spec.ts` to use configurable agent command**
...
- [x] **Add tests for configurable agent command**
