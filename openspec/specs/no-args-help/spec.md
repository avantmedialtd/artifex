# no-args-help Specification

## Purpose

Provide immediate guidance to users by displaying the help page when the CLI is invoked without arguments. This improves discoverability and reduces friction for new users who may not know about the `--help` flag or available commands.
## Requirements
